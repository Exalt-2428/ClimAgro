...
//               type="text"
//               placeholder="Search"
//               className="px-4 py-2 rounded-md focus:ring-2 focus:ring-red-500 focus:outline-none text-red-500"
//             />
//           </div>
//           <div className="relative">
//             <p>CUSTOMER LOGIN:</p>
...
//             <a href="/smart-farm" className="text-white cursor-pointer">
//               Cropin Grow (SmartFarm)
//             </a>
//             {/* <Icon icon="pepicons-pencil:line-y" className="text-white" /> */}
//             <a href="/smart-risk" className="text-white cursor-pointer">
